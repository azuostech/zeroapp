...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .header { background: #0a0a0a; padding: 32px 36px 24px; text-align: center; }
  .logo { font-size: 32px; font-weight: 900; color: #00C853; letter-spacing: -1px; }
  .tagline { font-size: 12px; color: #555; text-transform: uppercase; letter-spacing: 2px; margin-top: 4px; }
  ...
  .highlight { background: #0a0a0a; border-radius: 12px; padding: 20px 24px; margin-bottom: 24px; }
  .hl-label { font-size: 11px; color: #555; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px; }
  .hl-value { font-size: 28px; font-weight: 800; color: #FFD700; font-family: 'Courier New', monospace; }
  .hl-sub { font-size: 12px; color: #888; margin-top: 4px; }
  ...
  .section-title { font-size: 16px; font-weight: 800; color: #111; margin-bottom: 12px; }
  ...
  .quote-green  { border-color: #00C853; background: #f0faf5; color: #333; }
  .quote-rose   { border-color: #FB7185; background: #fff5f7; color: #333; }
  .quote-purple { border-color: #A78BFA; background: #f5f3ff; color: #7c3aed; font-weight: 700; font-size: 15px; }
  .cta-box { background: #0a0a0a; border-radius: 12px; padding: 20px 24px; text-align: center; margin: 24px 0; }
  .cta-text { font-size: 14px; color: #888; margin-bottom: 14px; line-height: 1.6; }
  .cta-btn { display: inline-block; background: #00C853; color: #000; font-weight: 800; font-size: 13px; padding: 12px 28px; border-radius: 10px; text-decoration: none; text-transform: uppercase; letter-spacing: 0.5px; }
  .assinatura { font-size: 14px; color: #555; line-height: 1.9; margin-top: 20px; }
  .assinatura strong { color: #111; }
